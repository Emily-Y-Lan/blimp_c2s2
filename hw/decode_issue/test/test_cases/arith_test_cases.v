...
task test_case_add();
  ...
  fork
    begin
      //   addr   inst
      send('h200, "add x4, x1, x2");
      send('h204, "add x2, x5, x4");
    end
...
task test_case_addi();
  ...
  fork
    begin
      //   addr   inst
      send('h200, "addi x3, x1, 10"  );
      send('h204, "addi x2, x3, 2047");
    end
...
task test_case_mul();
  ...
  fork
    begin
      //   addr   inst
      send('h200, "addi x3, x0, 10");
      send('h204, "addi x2, x0,  5");
      send('h208, "mul  x4, x3, x2");
      send('h20c, "mul  x4, x4, x2");
      send('h210, "mul  x4, x4, x4");
    end
