...
task test_case_directed_blt_1_basic();
  t.test_case_begin( "test_case_directed_blt_1_basic" );
  ...
  check_trace( 'h204, 'x, 'x,          0 ); // blt  x0, x1, 0x20c
...
task test_case_directed_blt_2_taken();
  t.test_case_begin( "test_case_directed_blt_2_taken" );
  if( !t.run_test ) return;
  fl_reset();
...
task test_case_directed_blt_3_not_taken();
  t.test_case_begin( "test_case_directed_blt_3_not_taken" );
  if( !t.run_test ) return;
  fl_reset();
...
task test_case_directed_blt_4_chain();
  t.test_case_begin( "test_case_directed_blt_4_chain" );
  if( !t.run_test ) return;
  fl_reset();
  ...
  asm( 'h218, "blt  x1,  x2, 0x220" );
  asm( 'h21c, "addi x7,  x0, 2"     );
  asm( 'h220, "blt  x3,  x4, 0x228" );
  asm( 'h224, "addi x8,  x0, 3"     );
  asm( 'h228, "blt  x5,  x6, 0x230" );
  ...
  check_trace( 'h218, 'x, 'x, 0 ); // blt  x1,  x2, 0x220
  check_trace( 'h220, 'x, 'x, 0 ); // blt  x3,  x4, 0x228
  check_trace( 'h228, 'x, 'x, 0 ); // blt  x5,  x6, 0x230
...
task test_case_directed_blt_5_backward();
  t.test_case_begin( "test_case_directed_blt_5_backward" );
  if( !t.run_test ) return;
  fl_reset();
  ...
  check_trace( 'h210, 'x, 'x, 0 ); // blt  x0,  x1, 0x244
  check_trace( 'h244, 14, 11, 1 ); // addi x14, x0, 11
  check_trace( 'h248, 'x, 'x, 0 ); // blt  x15, x0, 0x238
  check_trace( 'h238, 11,  9, 1 ); // addi x11, x0, 9
  check_trace( 'h23c, 'x, 'x, 0 ); // blt  x12, x0, 0x228
  check_trace( 'h228,  7,  6, 1 ); // addi x7,  x0, 6
  check_trace( 'h22c, 'x, 'x, 0 ); // blt  x0,  x8, 0x214
...
task test_case_directed_blt_6_loop();
  t.test_case_begin( "test_case_directed_blt_6_loop" );
  if( !t.run_test ) return;
  fl_reset();
  ...
  check_trace( 'h20c, 'x, 'x, 0 ); // blt  x1, x0, 0x204
...
task test_case_directed_blt_7_loop_self();
  t.test_case_begin( "test_case_directed_blt_7_loop_self" );
  if( !t.run_test ) return;
  fl_reset();
  ...
  asm( 'h200, "addi x1, x0, -1"    );
  asm( 'h204, "blt  x1, x0, 0x204" );

  // Check each executed instruction

  check_trace( 'h200,  1, -1, 1 ); // addi x1, x0, -1
  check_trace( 'h204, 'x, 'x, 0 ); // blt  x1, x0, 0x204
  check_trace( 'h204, 'x, 'x, 0 ); // blt  x1, x0, 0x204
  check_trace( 'h204, 'x, 'x, 0 ); // blt  x1, x0, 0x204
  check_trace( 'h204, 'x, 'x, 0 ); // blt  x1, x0, 0x204
