...
task test_case_directed_mul_1_basic();
  t.test_case_begin( "test_case_directed_mul_1_basic" );
...
task test_case_directed_mul_2_x0();
  t.test_case_begin( "test_case_directed_mul_2_x0" );
  if( !t.run_test ) return;
  fl_reset();
...
task test_case_directed_mul_3_pos();
  t.test_case_begin( "test_case_directed_mul_3_pos" );
  if( !t.run_test ) return;
  fl_reset();
...
task test_case_directed_mul_4_neg();
  t.test_case_begin( "test_case_directed_mul_4_neg" );
  if( !t.run_test ) return;
  fl_reset();
...
task test_case_directed_mul_5_overflow();
  t.test_case_begin( "test_case_directed_mul_5_overflow" );
  if( !t.run_test ) return;
  fl_reset();
