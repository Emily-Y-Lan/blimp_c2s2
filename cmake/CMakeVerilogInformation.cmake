...
elseif(CMAKE_Verilog_COMPILER_ID STREQUAL "VCS")
  # "Compile" file - use Xman to act as a preprocessor (need to use sh for redirection)
  if(NOT CMAKE_Verilog_COMPILE_OBJECT)
    set(CMAKE_Verilog_COMPILE_OBJECT
  ...
  # Run VCS when linking (need to use sh for redirection)
  if(NOT CMAKE_Verilog_LINK_EXECUTABLE)
    set(CMAKE_Verilog_LINK_EXECUTABLE
      "bash -c 'set -o pipefail && <CMAKE_Verilog_COMPILER> -sverilog -q <LINK_LIBRARIES> <OBJECTS> -Mdir=<TARGET>.gen -o <TARGET> +warn=none | sed -n \'/Error/,+5p\''"
    )
  endif()
