...
uint32_t rs1_mask(std::string reg_name) { return reg_masks.at(reg_name) << 15; }

uint32_t rs2_mask(std::string reg_name) { return reg_masks.at(reg_name) << 20; }

uint32_t rd_mask(std::string reg_name) { return reg_masks.at(reg_name) << 7; }
