...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -O3 -D_RISCV -fno-builtin")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++20")
set( CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -nostdlib -nostartfiles -T${CMAKE_CURRENT_SOURCE_DIR}/scripts/tinyrv2.ld -march=rv32imac -mabi=ilp32 ${CMAKE_CURRENT_SOURCE_DIR}/scripts/crt0.S" )