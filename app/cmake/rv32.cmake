...
if(NOT DEFINED RISCV_TOOLCHAIN_CONFIGURED)
  if(NOT DEFINED TOOLCHAIN_PREFIX)
    set(TOOLCHAIN_PREFIX riscv64-unknown-linux-gnu- CACHE STRING "")
  endif()
  ...
  message(STATUS "Found RISCV toolchain path, prefix, and ext: ${RISCV_TOOLCHAIN_BIN_PATH}, ${RISCV_TOOLCHAIN_BIN_GCC}, ${RISCV_TOOLCHAIN_BIN_EXT}")
...
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -nostdlib -nostartfiles -T${CMAKE_CURRENT_SOURCE_DIR}/scripts/tinyrv2.ld -L${CMAKE_CURRENT_BINARY_DIR}" )